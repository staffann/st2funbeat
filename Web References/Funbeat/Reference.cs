...
namespace Janohl.ST2Funbeat.Funbeat {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="TrainingServiceSoap", Namespace="http://services.funbeat.se/")]
    public partial class TrainingService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://services.funbeat.se/AddTraining", RequestNamespace="http://services.funbeat.se/", ResponseNamespace="http://services.funbeat.se/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public System.Nullable<int> AddTraining(Login login, Training training) {
        ...
        /// <remarks/>
        public void AddTrainingAsync(Login login, Training training) {
            this.AddTrainingAsync(login, training, null);
        }
        
        /// <remarks/>
        public void AddTrainingAsync(Login login, Training training, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://services.funbeat.se/GetTrainingTypes", RequestNamespace="http://services.funbeat.se/", ResponseNamespace="http://services.funbeat.se/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public TrainingType[] GetTrainingTypes() {
            object[] results = this.Invoke("GetTrainingTypes", new object[0]);
            return ((TrainingType[])(results[0]));
        }
        
        /// <remarks/>
        public void GetTrainingTypesAsync() {
            this.GetTrainingTypesAsync(null);
        }
        
        /// <remarks/>
        public void GetTrainingTypesAsync(object userState) {
            ...
            this.InvokeAsync("GetTrainingTypes", new object[0], this.GetTrainingTypesOperationCompleted, userState);
        }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://services.funbeat.se/")]
